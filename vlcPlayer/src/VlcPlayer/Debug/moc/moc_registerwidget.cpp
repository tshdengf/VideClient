...
QT_MOC_LITERAL(1, 15, 12), // "RegistetOver"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 17) // "CloseRegisterForm"

    },
    "RegisterWidget\0RegistetOver\0\0"
    "CloseRegisterForm"
};
...
void RegisterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RegistetOver(); break;
        case 1: _t->CloseRegisterForm(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RegisterWidget::RegistetOver)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWidget::RegistetOver()
{
